...
require("lazy").setup({
  ...
  "ctrlpvim/ctrlp.vim", -- Full path fuzzy file, buffer, mru, tag...
  {
    "junegunn/fzf.vim",
    dependencies = { 
      "junegunn/fzf", 
...
-- Map <leader>a to execute :Ag with the word under the cursor
vim.api.nvim_set_keymap('n', '<leader>a', ':Ag <C-R><C-W><CR>', { noremap = true, silent = true })
